    ...
    <div id="page-content">
        <div class="container-fluid px-4">
            ...
            @if ($profile)
                    ...
                    <div class="col-xl-3 col-lg-4">
                        <div class="card shadow-sm border-0 text-center p-4 mb-4">
                            <div class="position-relative d-inline-block mx-auto">
                                <img src="{{ asset($profile->profile_picture) }}" class="rounded-circle border p-1"
                        ...
                        <div class="card shadow-sm border-0 mb-4">
                            <div
                                ...
                                <ul class="nav nav-tabs profile-tabs border-bottom-0" id="profileTab" role="tablist">
                                    ...
                                    <li class="nav-item"><button class="nav-link" id="subjects-tab" data-bs-toggle="tab"
                                            data-bs-target="#subjects{{ $profile->id }}" type="button">Subjects</button>
                                    </li>
                                    <li class="nav-item"><button class="nav-link" id="edu-tab" data-bs-toggle="tab"
                                            data-bs-target="#edu{{ $profile->id }}" type="button">Education</button>
                                    </li>
                            ...
                            <div class="card-body p-4">
                                <div class="tab-content" id="profileTabContent">
                                    ...
                                    <!-- Subjects Tab -->
                                    <div class="tab-pane fade" id="subjects{{ $profile->id }}" role="tabpanel">
                                        ...
                                        @foreach ($profile->subjects as $subject)
                                            ...
                                            <div class="item-card d-flex justify-content-between align-items-center">
                                                <div>
                                                    <span class="fw-bold text-dark">{{ $subject->subject->name }}</span>
                                                    <span
                ...
                <div class="modal fade" id="editPhotoModal{{ $teacherId }}" tabindex="-1" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content border-0 shadow">
                            ...
                            <form class="ajaxForm" data-url="{{ route('teacher.profile.photo') }}" method="POST"
                                enctype="multipart/form-data" data-id="{{ $teacherId }}">
                                @csrf
                                @method('PUT')
                                <div class="modal-body">
                                    <input type="file" value="{{ asset($profile->profile_picture) }}"
                ...
                {{-- Edit Personal Modal --}}
                <div class="modal fade" id="editPersonalModal{{ $teacherId }}" tabindex="-1" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content border-0 shadow">
                            <div class="modal-header">
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select name="gender" class="form-select">
                                                <option value="N/A" {{ $profile->gender == 'N/A' ? 'selected' : '' }}>
                                                    N/A
                                                </option>
            ...
            @elseif($profile=='')
                <div class="row">
                    <div class="col-xl-12 col-lg-12" style="height: 100vh;">
                        <div class="card shadow-sm border-0 text-center p-4 mb-4" style="height: 100%;align-item:center;justify-content:center;">
                            <div class="position-relative d-inline-block mx-auto" >
                                <i class="fa-solid fa-inbox" style="font-size:100px;"></i>
                                <p style="font-size:50px;">Check Your Inbox</p>
                            </div>
                        </div>
                    </div>
                </div>
