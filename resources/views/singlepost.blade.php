    ...
    <div class="row justify-content-center">
        <div class="col-lg-10">
            <div class="post-detail-container p-4">
                ...
                <div class="mb-4">
                    <button type="button" class="btn-contact-custom" data-bs-toggle="modal" data-bs-target="#contactTutorModal">
                ...
                <div class="mt-2">
                    ...
                    <div class="detail-row">
                        <div class="info-item">
                            ...
                            <span class="value">{{ $singlepost->user->phone ?? '+91-**********' }}</span>
                        </div>
                        <div class="info-item">
                        ...
                        <div class="info-item disabled">
                            ...
                            <span class="value">Not available online</span>
                        </div>
                    </div>
                    ...
                    <div class="detail-row">
                        <div class="info-item disabled">
                            ...
                            <span class="value">Not available for home tutoring</span>
                        </div>
                        <div class="info-item">
                            <i class="bi bi-car-front-fill"></i>
                            <span class="label">From:</span>
                            <span class="value">{{ $singlepost->getutorfrom }}</span>
                        </div>
                        <div class="info-item">
