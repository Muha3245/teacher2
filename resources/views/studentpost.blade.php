...
@section('content')
    ...
    <section class="posts" id="teacher-container">
        ...
        @foreach ($studentposts as $student)
            <div class="card">
                <a href="{{ route('studentsinglepost', $student->id) }}" class="card-name">{{ $student->user->name }}</a>

                <ul class="subject-list">
                    @foreach (json_decode($student->subjects ?? '[]') as $subject)
                        <li>{{ $subject }}</li>
                    @endforeach
                </ul>
                <ul class="subject-list">
                    @foreach (json_decode($student->language ?? '[]') as $lang)
                        <li>{{ $lang }}</li>
                    @endforeach
                </ul>
                ...
                <ul class="card-stats">
                    ...
                    <li>
                        ...
                        ${{ $student->budget }}/{{ $student->budgetType }}
                    </li>
                    {{-- <li>
                        <i class="fas fa-laptop"></i>
                        {{ $student->year_online }} yr.
                    </li>
                    <li>
                        <i class="fas fa-chalkboard-student"></i>
                        {{ $student->year_teaching }} yr.
                    </li> --}}
                </ul>
            </div>
        @endforeach
