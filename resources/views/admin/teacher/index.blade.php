                ...
                <table class="table table-hover align-middle border">
                    ...
                    <tbody>
                        ...
                        <tr class="{{ $teacher->is_blocked ? 'table-danger' : '' }}">
                            ...
                            <td><span class="text-truncate d-inline-block" style="max-width: 150px;">{{ $teacher->headline ?? '-' }}</span></td>
                            ...
                            <td>{{ $teacher->location->city ?? 'N/A' }}</td>
                            ...
                            <td class="text-center d-flex gap-3">
                                <button class="btn btn-outline-primary btn-sm rounded-pill px-3" data-bs-toggle="modal" data-bs-target="#teacherModal{{ $teacher->id }}">
                                ...
                                {{-- --- MODAL START --- --}}
                                <div class="modal fade text-start" id="teacherModal{{ $teacher->id }}" tabindex="-1" aria-hidden="true">
                                    <div class="modal-dialog modal-xl modal-dialog-scrollable">
                                        <div class="modal-content border-0 shadow">
                                            <div class="modal-header bg-primary text-white">
                                                <h5 class="modal-title"><i class="fa-solid fa-id-card me-2"></i> {{ $teacher->name }}'s Detailed Profile</h5>
                                                ...
                                                <div class="row g-4">
                                                    ...
                                                    <div class="col-md-3 border-end text-center">
                                                        ...
                                                        <div class="text-start small">
                                                            <p class="mb-1"><strong><i class="fa-solid fa-envelope me-2 text-primary"></i></strong> {{ $teacher->user->email ?? 'N/A' }}</p>
                                                            <p class="mb-1"><strong><i class="fa-solid fa-location-dot me-2 text-primary"></i></strong> {{ $teacher->location->city ?? '-' }}, {{ $teacher->location->state ?? '' }}</p>
                                                            <p class="mb-1"><strong><i class="fa-solid fa-calendar-check me-2 text-primary"></i></strong> Joined: {{ $teacher->created_at->format('M Y') }}</p>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-9">
                                                        {{-- Bio Section --}}
                                                        <div class="mb-4">
                                                            <h6 class="fw-bold text-uppercase text-primary border-bottom pb-2">About & Experience</h6>
                                                            <p class="text-muted small">{{ $teacher->profile_description ?? 'No description provided.' }}</p>
                                                            <div class="row g-2 mt-2">
                                                                <div class="col-6 col-md-3"><strong>Exp:</strong> {{ $teacher->years_teaching }} Years</div>
                                                                <div class="col-6 col-md-3"><strong>Online:</strong> {{ $teacher->years_online }} Years</div>
                                                                <div class="col-6 col-md-3"><strong>Travel:</strong> {{ $teacher->willing_to_travel ? 'Yes' : 'No' }}</div>
                                                                <div class="col-6 col-md-3"><strong>Price:</strong> {{ $teacher->min_price }}-{{ $teacher->max_price }}</div>
                                                            </div>
                                                        </div>

                                                        {{-- Subjects Grid --}}
                                                        <div class="mb-4">
                                                            <h6 class="fw-bold text-uppercase text-info border-bottom pb-2">
                                                                <i class="fa-solid fa-book me-2"></i> Subjects & Expertise Levels
                                                            </h6>
                                                                        ...
                                                                        <div class="card h-100 border-info-subtle bg-light-subtle shadow-sm">
                                                                            <div class="card-body py-2 px-3">
                                                                                ...
                                                                                <div class="small">
                                                                                    ...
                                                                                    <i class="fa-solid fa-arrow-right mx-1 small"></i> 
                                                                                    <span class="badge bg-info text-dark">{{ $subject->to_level }}</span>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                @empty
                                                                    <div class="col-12 text-muted small">No subjects listed.</div>
                                                                @endforelse
                                                            </div>
                                                        </div>
                                                        ...
                                                        {{-- Education List --}}
                                                        <div>
                                                            <h6 class="fw-bold text-uppercase text-success border-bottom pb-2">
                                                            ...
                                                            <div class="row g-3">
                                                                ...
                                                                @empty
                                                                    <div class="col-12 text-muted small">No education details found.</div>
                                                                @endforelse
                                                            </div>
                                                        </div>
                                                    </div> {{-- End Right Col --}}
