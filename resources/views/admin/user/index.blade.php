                    ...
                    <table class="table table-hover align-middle border">
                        ...
                        <tbody>
                            @forelse($users as $index => $user)
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end shadow-sm"
                                                ...
                                                <li>
                                                    <a class="dropdown-item text-success" href="#"
                                                        ...
                                                        data-bs-target="#coinModal{{ $user->id }}">
                                                        <i class="bi bi-coin me-2"></i> Coins
                                                    </a>
                                                </li>
                                                {{-- <li>
                                ...
                                <div class="modal fade" id="coinModal{{ $user->id }}" tabindex="-1"
                                    aria-labelledby="coinModalLabel{{ $user->id }}" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <form action="{{ route('admin.coins.add') }}" method="POST">
                                            @csrf
                                            <input type="hidden" name="user_id" value="{{ $user->id }}">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="coinModalLabel{{ $user->id }}">Add
                                                        Coins to {{ $user->name }}
                                                    </h5>
                                                ...
                                                <div class="modal-body">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="number" class="form-control" name="amount"
                                                            id="amount{{ $user->id }}" min="1" required>
                                                    </div>
                                                </div>
